...
public class createModel extends registryTools {
	...
	public static void main (String args[]) {
		...
		try {
			...
			ModelRDB rdbModel = ModelRDB.createModel(conn, model_name);
	...
	private static final void usage() {
		System.out.println("usage: java createModel <database_name>");
	}
}
