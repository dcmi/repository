...
public class classesServlet extends registryServlet  {
	...
	public void doPost (HttpServletRequest request, HttpServletResponse response)
		...
		try {		
			...
			RDFNode obj = summaryModel.createResource("http://www.w3.org/2000/01/rdf-schema#Class");
			...
			Bag refs = summaryModel.createBag("http://dublincore.org/dcregistry/classes/");
			int itemCount = 0;
			...
			summaryModel.close();
			transform(response, caw, classes_xsl);
