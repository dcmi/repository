...
public class refinementsServlet extends registryServlet  {
	...
	public void doPost (HttpServletRequest request, HttpServletResponse response)
		...
		try {		
			...
			Bag refs = summaryModel.createBag("http://dublincore.org/dcregistry/refinements/");
			int itemCount = 0;
			...
			summaryModel.close();
			transform(response, caw, refinements_xsl);
	...
	protected void setXSLTParms (Transformer transformer) {
		try {		
			...
			transformer.setParameter("reqType", "refinements");
