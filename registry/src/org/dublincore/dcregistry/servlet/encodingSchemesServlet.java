...
public class encodingSchemesServlet extends registryServlet  {
	...
	public void doPost (HttpServletRequest request, HttpServletResponse response)
		...
		try {		
			...
			Bag refs = summaryModel.createBag("http://dublincore.org/dcregistry/encoding/");
			int itemCount = 0;
			...
			summaryModel.close();
			transform(response, caw, encodingSchemes_xsl);
	...
	protected void setXSLTParms (Transformer transformer) {
		try {		
			...
			transformer.setParameter("reqType", "encodingSchemes");
