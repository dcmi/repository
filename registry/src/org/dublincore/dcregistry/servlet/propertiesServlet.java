...
public class propertiesServlet extends registryServlet  {
	...
	public void doPost (HttpServletRequest request, HttpServletResponse response)
		...
		try {		
			...
			RDFNode obj = summaryModel.createResource("http://www.w3.org/1999/02/22-rdf-syntax-ns#Property");
			
			ArrayList rList = new ArrayList();
			String term = null;
			String termname = null;
			ResIterator ri = rdbModel.listSubjectsWithProperty(RDF.type, obj);
			while (ri.hasNext()) {
			...
			Bag refs = summaryModel.createBag("http://dublincore.org/dcregistry/properties/");
			int itemCount = 0;
			...
			summaryModel.close();
			transform(response, caw, properties_xsl);
