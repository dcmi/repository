...
public class remoteTermUpdatesClient extends remoteRegistryServlet  {
	...
	String termLang = null;
	 ...
	 public void doPost (HttpServletRequest request, HttpServletResponse response)
		...
		org.dublincore.dcregistry.services.Updates binding = null;
		java.net.URL portAddress = new java.net.URL(port);
		try {
			binding = new org.dublincore.dcregistry.services.TermUpdatesLocator().gettermUpdates(portAddress);
		}
		...
		try {
				...
				value = binding.getTermUpdates(port, termDate, termLang);
