...
public class remoteItemSummaryClient extends remoteRegistryServlet  {
        ...
        org.dublincore.dcregistry.services.Summary binding = null;
				java.net.URL portAddress = new java.net.URL(port);
        try {
            binding = new org.dublincore.dcregistry.services.ItemSummaryLocator().getitemSummary(portAddress);
        }
            ...
            if(jre.getLinkedCause()!=null)
				...
				try {
					...
					value = binding.listItemSummary(port);
