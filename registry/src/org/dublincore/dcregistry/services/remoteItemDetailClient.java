...
public class remoteItemDetailClient extends remoteRegistryServlet  {
	...
	String termLang = null;
	 ...
	 public void doPost (HttpServletRequest request, HttpServletResponse response)
			...
			org.dublincore.dcregistry.services.Detail binding = null;
			java.net.URL portAddress = new java.net.URL(port);
			try {
				binding = new org.dublincore.dcregistry.services.ItemDetailLocator().getitemDetail(portAddress);
			}
			...
			try {
				...
				//System.out.println("calling service with: " + term + ", " + termLang);
				value = binding.getItemDetail(port, term, termLang);
				//System.out.println("service returned: " + value);
	...
	public void getInputParameters (HttpServletRequest request, HttpSession session) {
		...
		termLang = request.getParameter("termLang");
