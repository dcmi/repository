...
public class remoteElementSummaryClient extends remoteRegistryServlet  {
		...
		public void doPost (HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException  {
				...
				org.dublincore.dcregistry.services.Elements binding = null;
				java.net.URL portAddress = new java.net.URL(port);
				try {
				    binding = new org.dublincore.dcregistry.services.ElementSummaryLocator().getelementSummary(portAddress);
				}
				...
				/*
				services.proxy.Elements binding = null;
				binding = new services.proxy.ElementSummaryLocator().getelementSummary();
				value = binding.listElements();
				*/
				
				try {
					java.lang.String value = null;
					value = binding.listElements(port);
