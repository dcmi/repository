...
public class remoteRefinementsSummaryClient extends remoteRegistryServlet  {
        ...
        org.dublincore.dcregistry.services.ElementRefinements binding = null;
				java.net.URL portAddress = new java.net.URL(port);
        try {
            binding = new org.dublincore.dcregistry.services.RefinementsSummaryLocator().getrefinementsSummary(portAddress);
        }
            ...
            if(jre.getLinkedCause()!=null)
				...
				try {
					...
					value = binding.listElementRefinements(port);
