...
public class listRegisteredServicesServlet extends remoteRegistryServlet  {
		...
		public void doPost (HttpServletRequest request, HttpServletResponse response)
			...
			try {
				...
				tempModel = remoteModel.query(s1);
				...
				tempModel.close();
				remoteModel.close();
				transform(response, caw, "listRegisteredServices.xsl");		
