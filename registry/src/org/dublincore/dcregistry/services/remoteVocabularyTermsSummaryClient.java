...
public class remoteVocabularyTermsSummaryClient extends remoteRegistryServlet  {
        ...
        org.dublincore.dcregistry.services.VocabularyTerms binding = null;
				java.net.URL portAddress = new java.net.URL(port);
        try {
            binding = new org.dublincore.dcregistry.services.VocabularyTermsSummaryLocator().getvocabularyTermsSummary(portAddress);
        }
            ...
            if(jre.getLinkedCause()!=null)
				...
				/*
				services.proxy.VocabularyTerms binding = null;
				binding = new services.proxy.VocabularyTermsSummaryLocator().getvocabularyTermsSummary();
				value = binding.listVocabularyTerms();
				*/
				
				try {
					java.lang.String value = null;
					value = binding.listVocabularyTerms(port);
