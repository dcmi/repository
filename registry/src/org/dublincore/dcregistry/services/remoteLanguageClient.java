...
public class remoteLanguageClient extends remoteRegistryServlet  {
        ...
        org.dublincore.dcregistry.services.Languages binding = null;
				java.net.URL portAddress = new java.net.URL(port);
        try {
            binding = new org.dublincore.dcregistry.services.LanguagesSummaryLocator().getlanguagesSummary(portAddress);
        }
            ...
            if(jre.getLinkedCause()!=null)
				...
				try {
					...
					value = binding.listSupportedLanguages(port);
