...
<xsl:template match="rdf:RDF">
	...
	<table width="75%">
	<tr><td>
	<h4><xsl:value-of disable-output-escaping='yes' select="java:getString($resources,'summary_appProfiles')"/></h4>
	</td><td align="right">
...
<xsl:template name="print-local-link">
    ...
    <xsl:param name="item"/>
        ...
        <tr><td>
        <a class="label"><xsl:attribute name="href"><xsl:value-of select="concat('/dcregistry/detailServlet?reqType=adetail', '&amp;', 'item=', $encoded_item)"/></xsl:attribute>
