...
var gDocTable = new Array(
   new hrefList("slide0039.htm", 1, 1),
   new hrefList("slide0029.htm", 1, 2),
   new hrefList("slide0038.htm", 1, 3),
   new hrefList("slide0022.htm", 1, 4),
   new hrefList("slide0020.htm", 1, 5),
   new hrefList("slide0021.htm", 1, 6),
   new hrefList("slide0017.htm", 1, 7),
   new hrefList("slide0030.htm", 1, 8),
   new hrefList("slide0040.htm", 1, 9),
   new hrefList("slide0018.htm", 1, 10),
   new hrefList("slide0015.htm", 1, 11),
   new hrefList("slide0044.htm", 1, 12),
   new hrefList("slide0041.htm", 1, 13),
   new hrefList("slide0023.htm", 1, 14),
   new hrefList("slide0026.htm", 1, 15),
   new hrefList("slide0024.htm", 1, 16),
   new hrefList("slide0045.htm", 1, 17),
   new hrefList("slide0046.htm", 1, 18),
   new hrefList("slide0031.htm", 1, 19),
   new hrefList("slide0042.htm", 1, 20),
   new hrefList("slide0047.htm", 1, 21),
   new hrefList("slide0014.htm", 1, 22),
   new hrefList("slide0048.htm", 1, 23),
   new hrefList("slide0049.htm", 1, 24)
);
