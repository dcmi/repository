...
var gDocTable = new Array(
   ...
   new hrefList("slide0013.htm", 1, 6),
   new hrefList("slide0028.htm", 1, 7),
   ...
   new hrefList("slide0032.htm", 1, 12),
   new hrefList("slide0033.htm", 1, 13),
   new hrefList("slide0034.htm", 1, 14),
   new hrefList("slide0005.htm", 1, 15),
   new hrefList("slide0010.htm", 1, 16)
);
