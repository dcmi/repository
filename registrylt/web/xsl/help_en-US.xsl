...
<xsl:param name="action" select="'help'"/>
...
<xsl:call-template name="banner">		
	...
	<p/>
	http://dublincore.org/dcregistrylt/listItemSummary
	...
	<br/>Sample Call: <a href="/dcregistrylt/listItemSummary">
	http://dublincore.org/dcregistrylt/listItemSummary</a>
	
	<p/>
	http://dublincore.org/dcregistrylt/listSupportedLanguages
	<br/>Summary: This service returns a list of all supported languages. 
	<br/>Parameters: No input parameters are required.
	<br/>Sample Call: <a href="/dcregistrylt/listSupportedLanguages">
	http://dublincore.org/dcregistrylt/listSupportedLanguages</a>
	
	<p/>
	http://dublincore.org/dcregistrylt/listItemDetail
	...
	<br/>Sample Call: 
	<a href="/dcregistrylt/listItemDetail?item=http://purl.org/dc/elements/1.1/creator&amp;lang=en-US">
	http://dublincore.org/dcregistrylt/listItemDetail?item=http://purl.org/dc/elements/1.1/creator&amp;lang=en-US</a>
	
	<p/>
	http://dublincore.org/dcregistrylt/getUpdates
	...
	<br/>Sample Call: <a href="/dcregistrylt/getUpdates?date=20030101&amp;lang=en-US">
	http://dublincore.org/dcregistrylt/getUpdates?date=20030101&amp;lang=en-US</a>
	
	<p/>
	http://dublincore.org/dcregistrylt/listElements
	<br/>Summary: This service returns a list of all registered elements. 
	<br/>Parameters: No input parameters are required.
	<br/>Sample Call: <a href="/dcregistrylt/listElements">
	http://dublincore.org/dcregistrylt/listElements</a>	
		
	<p/>
	http://dublincore.org/dcregistrylt/listElementRefinements
	<br/>Summary: This service returns a list of all registered element refinements. 
	<br/>Parameters: No input parameters are required.
	<br/>Sample Call: <a href="/dcregistrylt/listElementRefinements">
	http://dublincore.org/dcregistrylt/listElementRefinements</a>
		
	<p/>
	http://dublincore.org/dcregistrylt/listVocabularyTerms
	<br/>Summary: This service returns a list of all registered controlled vocabulary terms. 
	<br/>Parameters: No input parameters are required.
	<br/>Sample Call: <a href="/dcregistrylt/listVocabularyTerms">
	http://dublincore.org/dcregistrylt/listVocabularyTerms</a>
	
	<p/>
	http://dublincore.org/dcregistrylt/listEncodingSchemes
	<br/>Summary: This service returns a list of all registered encoding schemes. 
	<br/>Parameters: No input parameters are required.
	<br/>Sample Call: <a href="/dcregistrylt/listEncodingSchemes">
	http://dublincore.org/dcregistrylt/listEncodingSchemes</a>
	...
	itemSummary and itemDetail services, can be found <a href="/dcregistrylt/sampleClient.tar.gz">here</a>.  
	...
	<a href="/dcregistrylt/WSInspectionExample2.tar">here</a>.
