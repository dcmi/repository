---
title: "- DCXMLRevision/DCXMLGuidelines/2006-05-16"
...
tags: []
aliases:
- "/archive/moinmoin_wiki/architecturewiki/pages/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16.html"
---

**2012-01-05. Frozen archive - links may not resolve - see directory of files at [MoinMoin wiki archive](/moinmoin-wiki-archive/)**

# > [DCXMLRevision/DCXMLGuidelines/2006-05-16](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=fullsearch&value=%2F2006-05-16&literal=1&case=1&context=40 "Click here to do a full-text search for this title")
...
- [Edit](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=edit "Edit")
- [View](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16 "View")
- [Diffs](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=diff "Diffs")
- [Info](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=info "Info")
- [Subscribe](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=subscribe "Subscribe")
- [Raw](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=raw "Raw")
- [Print](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=print "Print")

Actions

- [AttachFile](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=AttachFile)
- [DSP2XML](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=DSP2XML)
- [DeletePage](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=DeletePage)
- [LikePages](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=LikePages)
- [LocalSiteMap](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=LocalSiteMap)
- [SpellCheck](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=SpellCheck)

Search

<form method="POST" action="/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16">
<p>
<input name="action" value="inlinesearch" type="hidden">
<input name="context" value="40" type="hidden">
Title: <input name="text_title" size="15" maxlength="50" type="text"><input src="DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16_files/moin-search.png" name="button_title" alt="[?]" type="image"><br>Text: <input name="text_full" size="15" maxlength="50" type="text"><input src="DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16_files/moin-search.png" name="button_full" alt="[?]" type="image">
</p>
</form>

## Expressing Dublin Core Metadata in XML

This document is part of the [<img src="DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16_files/moin-inter.png" alt="[Self]" height="16" width="16">DC Architecture Wiki](http://dublincore.org/architecturewiki/ "Self").
...
<table bgcolor="#ffffcc" width="100%">
  <tbody>
    <tr>
      ...
      <td>
        <strong>Expressing Dublin Core Metadata in XML</strong> </td>
    </tr>
    <tr>
      <td>
...
The DCMI Abstract Model [DCAM] describes the entities that make up a DC metadata description set and the relationships between those entities. In order to represent a DC metadata description set in an XML document the entities it comprises have to be represented as components in that XML document, i.e. as XML elements and XML attributes, XML element names and XML attribute names, and as XML element content and XML attribute values.

#### 1.1 Design Considerations

The DC-XML format described in this document was developed using the following design considerations:

- The format should provide a serialisation of all the features of the "Description Model" of the DCAM, i.e. it should be possible to represent all the entities that make up a DC metadata description set and the relationships between them. (See Note 1).
...
&lt;dcx:descriptionSet
  ...
  &lt;dcx:description
    ...
    &lt;/dc:title&gt;
    &lt;dc:description&gt;
      &lt;dcx:XMLRepresentation &lt;!-- external XML data --&gt;
        dcx:representationURI="http://example.org/docs/doc.xml" /&gt;
    &lt;/dc:description&gt;
  &lt;/dcx:description&gt;
&lt;/dcx:descriptionSet&gt;
</pre>
...
A binary data _rich representation_ may be provided in two ways. It may be provided "inline" within the DC-XML document or it may be provided as a separate XML document, the URI of which is provided as an attribute value.

Inline binary data is represented by the content of a Value Representation Element with the element name <tt>dcx:binaryRepresentation</tt>. The XML element content is a Base64 encoding of the binary object. The value of the attribute <tt>dcx:mimeType</tt> provides the MIME type for the binary data object; the attribute must be present and the value must be a valid MIME type.
  ...
  &lt;dcx:description
    ...
    &lt;dc:description&gt;
      &lt;dcx:binaryRepresentation
       ...
       dcx:mimeType="image/png"&gt;AABBCCDDEEFF&lt;/dcx:binaryRepresentation&gt;
    &lt;/dc:description&gt;
  &lt;/dcx:description&gt;
&lt;/dcx:descriptionSet&gt;
</pre>
...
&lt;dcx:descriptionSet
  ...
  &lt;dcx:description
    ...
    &lt;/dc:title&gt;
    &lt;dc:description&gt;
      &lt;dcx:binaryRepresentation &lt;!-- external binary data object --&gt;   
...
DescriptionSet (
  Description (
    ...
    Statement (
      PropertyURI ( dc:description )
      RichRepresentation ( 
        Base64 ( "AABBCCDDEEFF" MIME ( "image/png" ) )
      )
    )
  )
)
...
<a id="GRDDL"></a>**[GRDDL]**  
_Gleaning Resource Descriptions from Dialects of Languages (GRDDL)_ W3C Coordination Group Note 13 April 2004  
...
_DC-Text: A Text Syntax for Dublin Core Metadata_ Draft of 2006-05-22.  
 [http://dublincore.org/architecturewiki/DCText/2006-05-22](http://dublincore.org/architecturewiki/DCText/2006-05-22)

 [RefreshCache](http://dublincore.org/architecturewiki/DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16?action=refresh&arena=Page.py&key=DCXMLRevision_2fDCXMLGuidelines_2f2006_2d05_2d16.text_html) for this page (cached 2012-12-21 18:19:43)  

Immutable page (last edited 2006-05-21 19:58:55 by [PeteJohnston](http://dublincore.org/architecturewiki/PeteJohnston))
